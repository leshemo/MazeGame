...
//            this.cameFromEdge.put(e.to, next); // ,next);
//          }
...
//
//
//  void reconstruct(Vertex end) {
//    ArrayList<Vertex> pathToEnd = new ArrayList<Vertex>(); //add to front
//    Vertex current = end;
//    System.out.println("recon");
//    for (Vertex v: this.cameFromEdge.keySet()) {
//      System.out.println(v.name + " -> " + this.cameFromEdge.get(v).name);
//    }
...
//    }
//    for (Vertex v: pathToEnd) {
//      System.out.println(v.name);
//    }
//    this.solutionPath = pathToEnd;
//  }
//
//  boolean searchOver() {
...
//      image.placeImageXY(new RectangleImage(this.scale, this.scale,"solid", new Color(138,192,255)), 
...
//  //        && t.checkExpect(this.w3.endReached, true);
//  //
//  ////  System.out.println(this.w3.graph.allEdges.size());
//  //
//  //    System.out.println(this.w3.graph.allEdges.get(3).from.outEdges.size());
//  //    
//  //    
