...
//  public boolean isPosition(int x1, int y1) {
...
//  ArrayList<Vertex> verticiesVisited;
//
...
//    this.verticiesVisited = new ArrayList<Vertex>();
//  }
//
//
...
//     this.searchHelp(from, to, new Queue<Vertex>());
//  }
//
//  //stack is for depth-first search
//  void dfs(Vertex from, Vertex to) {
//    this.searchHelp(from, to, new Stack<Vertex>());
//  }
//
...
//        this.solutionPath = reconstruct(cameFromEdge, next); // Success!
//
//      }
//      else {
...
//
//  
//  ArrayList<Vertex> reconstruct(HashMap<Vertex, Edge> cameFromEdge, Vertex end) {
//    ArrayList<Vertex> pathToEnd = new ArrayList<Vertex>(); //add to front
//    Vertex current = end;
//    while (!current.isPosition(0, 0)) {
//      pathToEnd.add(0, current);
//      Vertex temp = cameFromEdge.get(current).to;
//      if (temp.equals(current)) {
//        current = cameFromEdge.get(current).from;
//      }
//      else {
//        current = temp;
//      }
...
//    this.mazeWallsImage = this.graph.makeGraphScene(this.scale, this.width, this.height);
//
//  }
//
...
//    // Walls
//    image.placeImageXY(this.mazeWallsImage, this.width * this.scale / 2, this.height * this.scale / 2); 
//    // Player
//    image.placeImageXY(new CircleImage(this.scale / 2,"solid", new Color(207,85,81)), 
//        this.playerPos.x * this.scale + this.scale / 2, this.playerPos.y * this.scale + this.scale / 2);
//
//
//    return image;
//  }
...
//        }
//      }
//      //      System.out.println(this.playerPos.x+" "+ this.width+" "+this.playerPos.y +" "+ this.height);
...
//    //      MazeWorld m = this.w3;
//    m.bigBang(width * scale, height * scale, .01);
//  }
//
